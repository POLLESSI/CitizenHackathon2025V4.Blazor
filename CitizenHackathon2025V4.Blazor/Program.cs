...
// Services Scoped
// -----------------------------
builder.Services.AddScoped<CitizenHackathon2025V4.Blazor.Client.Services.AuthService>();
...
builder.Services.AddScoped<CitizenHackathon2025V4.Blazor.Client.Services.UserService>();
